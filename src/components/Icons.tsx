import { FaBus, FaTrain, FaSubway } from "react-icons/fa";
import { MdTram, MdSubway } from "react-icons/md";
import { VehicleType } from "../typings";

const Icon = ({ type, style }: { type: VehicleType, style?: React.CSSProperties }) => {
    const icons = {
        bus: <FaBus style={style} />,
        tram: <MdTram style={style} />,
        metro: <MdSubway style={style} />,
        wkd: <FaTrain style={style} />,
        skm: <FaSubway style={style} />,
        km: <FaSubway style={style} />,
        trolley: <svg viewBox="0 0 24 24" style={style}><path d="M13.853,4.257l1.722-3.302c0.159-0.307,0.041-0.687-0.267-0.847C15-0.051,14.62,0.067,14.46,0.375
            ...
            s1.563,0.698,1.563,1.563C18.253,19.157,17.556,19.856,16.69,19.856z M18.253,13.601H5.745V8.389h12.508V13.601"></path></svg>
    };
