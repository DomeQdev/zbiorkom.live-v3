...
export default ({ city, vehicle, mapBearing }: { city: City, vehicle: Vehicle, mapBearing: number }) => {
    ...
    return <>
        ...
        >
            ...
            {vehicle.brigade && <MenuItem onClick={() => navigate(`/${city}/brigades/${vehicle.route}.${vehicle.brigade}?back=true`)}><Commit style={{ width: 20, height: 20 }} color="primary" />&nbsp;Rozkład brygady</MenuItem>}
