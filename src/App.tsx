...
import { ArrowBack, AutoAwesome, Celebration, EmojiEmotions, Menu } from "@mui/icons-material";
        ...
        <ThemeProvider theme={theme}>
            ...
            <Fab
                ...
                onClick={() => {
                    if (eyes) return;
                    setEyes(true);
                    setTimeout(() => setEyes(false), 400);
                }}
            >
                {eyes ? <EmojiEmotions /> : <AutoAwesome />}
            </Fab>
            ...
            <ErrorBoundary>
                <Routes>
                    ...
                    <Route
                        path="city"
                        element={
                            <DocumentMeta title={`Wybór miasta - zbiorkom.live`}>
                                <Suspense>
                                    <CitySelection />
                                </Suspense>
                            </DocumentMeta>
                    ...
                    <Route path={city} key={city}>
                        <Route
                            ...
                            element={
                                <DocumentMeta
                                    title={`${cityData.name} Mapa - zbiorkom.live`}
                                    description={`Gdzie jest autobus, tramwaj, pociąg na żywo w mieście ${cityData.name}`}
                                >
                                    <Suspense>
                                        <Map city={city} style={{ position: "absolute" }}>
                                            <CityMap city={city} />
                                        </Map>
                                    </Suspense>
                                </DocumentMeta>
                        ...
                        {cityData.api.stops && (
                            <>
                                <Route
                                    ...
                                    element={
                                        <DocumentMeta
                                            title={`${cityData.name} Lista przystanków - zbiorkom.live`}
                                            description={`Lista wszystkich przystanków w mieście ${cityData.name}`}
                                        >
                                            <Suspense>
                                                <StopSearch city={city} location={userLocation} />
                                            </Suspense>
                                        </DocumentMeta>
                                    }
                                />
                        ...
                        {cityData.api.brigades && (
                            <>
                                <Route
                                    ...
                                    element={
                                        <DocumentMeta
                                            title={`${cityData.name} Rozkład brygad - zbiorkom.live`}
                                            description={`Rozkład brygad w mieście ${cityData.name}`}
                                        >
                                            <Suspense>
                                                <Brigades city={city} />
                                            </Suspense>
                        ...
                        {cityData.api.bikes && (
                            <Route
                                ...
                                element={
                                    <DocumentMeta
                                        title={`${cityData.name} Stacje rowerów miejskich - zbiorkom.live`}
                                        description={`Zobacz liczbę rowerów i wolnych stojaków na stacjach rowerowych w mieście ${cityData.name}!`}
                                    >
                                        <Suspense>
                                            <Bikes city={city} location={userLocation} />
                                        </Suspense>
                                    </DocumentMeta>
                                }
                            />
                        ...
                        {cityData.api.parkings && (
                            <Route
                                ...
                                element={
                                    <DocumentMeta
                                        title={`${cityData.name} Parkingi - zbiorkom.live`}
                                        description={`Zobacz wolne miejsca parkingowe w mieście ${cityData.name}!`}
                                    ></DocumentMeta>
                                }
                            />
                        )}
                        ...
                        <Route
                            path="settings/*"
                            element={
                                <DocumentMeta title={`${cityData.name} Ustawienia - zbiorkom.live`}>
                                    <Suspense>
                                        <Settings city={city} />
                                    </Suspense>
                                </DocumentMeta>
                    ...
                    <Route
                        ...
                        element={
                            <Suspense>
                                <Error text={"404"} message={"Nie znaleziono strony"} />
                            </Suspense>
                        }
                    />
                </Routes>
